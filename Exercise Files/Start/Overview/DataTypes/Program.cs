...
bool tf = default; // default(bool) = false
int x = default(int); // default(int) = 0
var k = default(float); // default(float) = 0.0f
//var h = default; // error: default requires a target type

Console.WriteLine($"{a}, {b}, {tf}, {c}, {f}, {d}, {x}, {k}");

// TODO: implicit type conversion
Console.WriteLine($"{c + a}"); // 'A' + 1 = 66
Console.WriteLine($"{(char)(a + c)}"); // 'A' + 1 = 'B'
Console.WriteLine($"{f + a}"); // 123.45 + 1 = 124.45
Console.WriteLine($"{f + c}"); // 123.45 + 'A' = 123.45 + 65 = 188.45
